    ...
    >
      ...
      >
        ...
        <div className="button-group">
          <button className="primary-cta" onClick={handleLoginClick}>
            Login
          </button>
          <button className="secondary-cta" onClick={handleSignUpClick}>
            Sign Up
          </button>
          <button className="tertiary-cta" onClick={handleExploreClick}>
            Explore as Guest
          </button>
        </div>
      </section>
